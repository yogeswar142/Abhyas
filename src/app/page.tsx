...
export default function Home() {
  ...
  // Scroll reveal tags
  const revealHeroLeft = useReveal<HTMLDivElement>()
  const revealStep1 = useReveal<HTMLDivElement>()
  const revealStep2 = useReveal<HTMLDivElement>()
  const revealStep3 = useReveal<HTMLDivElement>()
  const revealMetricsText = useReveal<HTMLDivElement>()
  const revealStat1 = useReveal<HTMLDivElement>()
  const revealStat2 = useReveal<HTMLDivElement>()
  const revealStat3 = useReveal<HTMLDivElement>()
  const revealStat4 = useReveal<HTMLDivElement>()
  const revealSessionsTitle = useReveal<HTMLDivElement>()
  const revealSession1 = useReveal<HTMLDivElement>()
  const revealSession2 = useReveal<HTMLDivElement>()
  const revealSession3 = useReveal<HTMLDivElement>()
  const revealSession4 = useReveal<HTMLDivElement>()
  const revealSession5 = useReveal<HTMLDivElement>()
  const revealTestimonialsTitle = useReveal<HTMLDivElement>()
  const revealTesti1 = useReveal<HTMLDivElement>()
  const revealTesti2 = useReveal<HTMLDivElement>()
  const revealTesti3 = useReveal<HTMLDivElement>()
  const revealPricingTitle = useReveal<HTMLDivElement>()
  const revealPrice1 = useReveal<HTMLDivElement>()
  const revealPrice2 = useReveal<HTMLDivElement>()
  const revealPrice3 = useReveal<HTMLDivElement>()
  ...
  const scoreCount = useCountUp<HTMLSpanElement>(87)
  const stat1Count = useCountUp<HTMLDivElement>(89)
  const stat2Count = useCountUp<HTMLSpanElement>(12)
  const stat3Count = useCountUp<HTMLSpanElement>(97)

  // Session card stagger entries
  const session1Reveal = useReveal<HTMLDivElement>()
  const session2Reveal = useReveal<HTMLDivElement>()
  const session3Reveal = useReveal<HTMLDivElement>()
  const session4Reveal = useReveal<HTMLDivElement>()
  const session5Reveal = useReveal<HTMLDivElement>()
